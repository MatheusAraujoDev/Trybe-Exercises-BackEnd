# Bloco 21 - Exercícios Dia 2

###### Faça os exercícios 1 a 9 utilizando banco de dados Pixar abaixo:
...
rial e o número de funcionários de todos os departamentos com mais de dez funcionários. Dica: agrupe pelo department_id .
